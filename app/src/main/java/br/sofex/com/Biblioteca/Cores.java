...
public class Cores {
    ...
    Context mContext;
    Cores(Context context)
    {this.mContext = context;}

    //TODO: Backup
    Integer  CorLaranja = Color.rgb(255, 152, 0);
    Integer  CorGreen = Color.rgb(101, 230, 20);
    Integer  CorVioleta = Color.rgb(156, 39, 176);

    Integer  CorBlue = Color.rgb(0, 72, 255);
    Integer  CorYellow = Color.rgb(255, 255, 0);
    Integer  CorRed  = Color.rgb(204, 51, 0);
    Integer  CorBlack = Color.rgb(0, 0, 0);

    Integer  CorMarrom = Color.rgb(187, 96, 8);
    Integer  CorAzulFM = Color.rgb(35, 164, 202);
    Integer  CorCinza = Color.rgb(113, 112, 111);
    ...
    String facialmap = "#23A4CA";

    //TODO: Purple colors
    String lavender = "#E6E6FA";
    String thistle = "#D8BFD8";
    String plum = "#DDA0DD";
    String violet = "#932191";
